...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    subscriptionForm.addEventListener("submit", function (event) {
        ...
        hideEmbeddedForm(); // Hide the embedded form after submission
    });

    // Check if the embedded form is still visible after a delay
    setTimeout(function () {
        if (window.getComputedStyle(embeddedForm).display !== "none") {
            // If the embedded form is still visible after the delay, assume the pop-up form was closed without subscribing
            showEmbeddedForm(); // Show the embedded form
        }
