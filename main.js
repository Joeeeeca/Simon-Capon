...
document.addEventListener("DOMContentLoaded", function () {
  // Check if the user previously closed the pop-up form without subscribing
  const hasClosedPopupWithoutSubscribing = localStorage.getItem("closedPopupWithoutSubscribing");

  // If the flag is not set or it's false, show the pop-up form
  if (!hasClosedPopupWithoutSubscribing || hasClosedPopupWithoutSubscribing === "false") {
      showPopupForm();
  }

  // Function to show the pop-up form
  function showPopupForm() {
      // Your code to display the pop-up form
      // For example:
  ...
  function hidePopupForm() {
      // Your code to hide the pop-up form
      // For example:
      // document.getElementById("popup-form").style.display = "none";
  }

  // Function to handle subscribing action
  function handleSubscribe() {
      // Your subscription logic
      // For example, if the user subscribes successfully:
      hidePopupForm();
      // Set localStorage flag to indicate that the user has subscribed
      localStorage.setItem("closedPopupWithoutSubscribing", "true");
  }

  // Function to handle closing action
  function handleClose() {
      // Your code to handle when the user closes the pop-up form without subscribing
      // For example:
      // Show the embedded form
      // document.getElementById("embedded-form").style.display = "block";
      // Set localStorage flag to indicate that the user closed the pop-up without subscribing
      localStorage.setItem("closedPopupWithoutSubscribing", "false");
  }

  // Add event listener for subscribe button click
